    ...
    public class ProductoService : IProductoService
    {
        ...
        public async Task<List<ProductoDTO>> Lista()
        {
            try
            {
                ...
                var listaProductos = queryProducto.Include(cat => cat.IdCatNavigation).ToList();
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                var productoEncontrado = await _productoRepositorio.Obtener(u =>
                    u.IdProd == productoModelo.IdProd
                );
                ...
                productoEncontrado.IdCat = productoModelo.IdCat;
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                ...
                var productoEncontrado = await _productoRepositorio.Obtener(p => p.IdProd == id);
